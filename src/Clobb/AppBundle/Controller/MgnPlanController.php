...
use Clobb\AppBundle\Entity\MgnPlan;
use Clobb\AppBundle\Form\MgnPlanType;
...
class MgnPlanController extends CoreController
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PortotechAppBundle:MgnPlan')->findAllPlans();
    ...
    public function getAction(Request $request, $id)
    {
        ...
        $entities = $em->getRepository('PortotechAppBundle:Planos')->find($id);
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $entity = $em->getRepository('PortotechAppBundle:Planos')->find($id);
        if (!$entity) {
